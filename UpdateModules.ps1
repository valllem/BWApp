...
if (Get-Module -ListAvailable -Name AADRM) {
    ...
    $ProgressBar1.Value = 20
    $LabelStatus.Text = "Status: Updating AADRM"
...
if (Get-Module -ListAvailable -Name AzureAD) {
    ...
    $LabelStatus.Text = "Status: Updating AzureAD"
...
if (Get-Module -ListAvailable -Name MicrosoftTeams) {
    ...
    $LabelStatus.Text = "Status: Updating MicrosoftTeams"
...
if (Get-Module -ListAvailable -Name Microsoft.Online.SharePoint.PowerShell) {
    ...
    $LabelStatus.Text = "Status: Updating SharePoint Online Module"
...
if (Get-Module -ListAvailable -Name MSOnline) {
    ...
    $LabelStatus.Text = "Status: Updating MSOnline"
...
if (Get-Module -ListAvailable -Name AzureRM) {
    ...
    $LabelStatus.Text = "Status: Updating AzureRM"
...
if (Get-Module -ListAvailable -Name CreateExoPsSession) {
    ...
    $LabelStatus.Text = "Status: Updating CreateExoPsSession"
    Update-Module -Name CreateExoPsSession -force
} 
else {
    Write-Host -foregroundcolor Yellow "Module does not exist..."
